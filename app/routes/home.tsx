            ...
            <div className="text-center space-y-6 px-4">
              ...
              <div className="pt-10">
                <button
                  ...
                  className="bg-white text-emerald-800 border border-emerald-300 px-10 py-4 rounded-full font-bold text-lg shadow-xl hover:scale-105 transition-transform"
                >
                  아래로 내려서 알아보기
                </button>
              </div>
            ...
            <footer className="w-full bg-gray-800 text-gray-400 py-10 px-6 shrink-0">
              <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    강원특별자치도 원주시 만대로 148 2층 | 이메일:
                    topgold777@daum.net | 전화: 033-746-7579
                  </p>
